...
public class SuperHero {
	...
	private SuperHero(String name, int lifePoints, boolean isVillain, boolean isWounded, WeaponInterface leftWeapon,
			WeaponInterface righttWeapon, String superPower, String superSuperPower) {
		super();
		this.name = name;
		...
		this.righttWeapon = righttWeapon;
